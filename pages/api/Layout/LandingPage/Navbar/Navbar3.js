    ...
    <>
      <nav className="py-4 ">
        <div className="container flex flex-wrap items-center justify-between mx-auto sm:relative absolute overflow-hidden">
          ...
          <div
            class={` transition ease-out duration-500 sm:transition-transform-none   md:flex md:items-center w-full  sm:bg-white bg-white ml-auto relative z-50 ${
          ...
          >
            ...
            <ul
              class={`scroll-smooth flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium  md:text-center mx-auto sm:py-0 py-4 md:mx-4`}
            >
              {links.map((items) => (
                <li key={items.id}>
                  <a
                    ...
                    // }}
                    href="#"
                    class={`active:border-2 block transition py-2 pr-4 pl-3 text-ulColor border-gray-100 font-normal text-xl   md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:text-white  dark:border-gray-700 ${
