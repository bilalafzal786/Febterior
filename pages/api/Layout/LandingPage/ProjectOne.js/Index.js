  ...
  return (
    <>
      <div className="container  mt-32 mx-auto lg:px-10 xl:px-10 md:px-6 px-4">
        <div className="grid sm:grid-cols-12 my-24">
          <div className="col-span-12 sm:col-span-8 lg:col-span-8 md:col-span-12 md:order-2 lg:order-1 order-2">
            <div className="grid grid-cols-12 items-center">
              <div className="col-span-12 lg:col-span-8 md:col-span-12 md:my-8 my-8">
              ...
              <div className="col-span-4 md:col-span-12 lg:col-span-4 flex justify-start md:invisible lg:visible pl-5">
                <hr className="h-1 bg-black w-24 sm:block hidden" />
              </div>
            </div>
          </div>

          <div className="col-span-12 sm:col-span-4 lg:col-span-4  md:col-span-12 sm:mx-auto mx-0 relative my-auto md:order-1 lg:order-2 order-1">
            <svg
              width="400"
              height="470"
