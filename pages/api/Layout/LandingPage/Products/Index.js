    ...
    <>
      <div className="container  mt-32 mx-auto lg:px-10 xl:px-10 md:px-6 px-4">
        <div className="grid grid-rows-1">
          ...
          <p className="text-para text-2xl leading-9 md:px-12 sm:px-44 px-2 text-center my-8">
        ...
        <div className="grid sm:grid-cols-12 my-24  ">
          <div className="col-span-12 sm:col-span-12 lg:col-span-4  md:col-span-12 sm:mx-auto mx-0 relative my-auto ">
            <svg
              width="400"
              height="470"
          ...
          <div className="col-span-12 sm:col-span-8 lg:col-span-8 md:col-span-12">
            <div className="grid grid-cols-12 items-center">
              <div className=" md:col-span-12 lg:col-span-4 flex justify-end md:invisible lg:visible pr-5">
      ...
      {/* <div className="parent block">
        ...
        <Image
          src={bottom}
          alt=""
          className="second absolute bottom-[44px] left-0"
          width={390}
          height={510}
          layout="responsive"
          objectFit="cover"
